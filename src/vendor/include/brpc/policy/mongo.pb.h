...
void AddDescriptors();
void InitDefaultsMongoHeaderImpl();
void InitDefaultsMongoHeader();
void InitDefaultsMongoRequestImpl();
void InitDefaultsMongoRequest();
void InitDefaultsMongoResponseImpl();
void InitDefaultsMongoResponse();
inline void InitDefaults() {
  InitDefaultsMongoHeader();
  InitDefaultsMongoRequest();
  InitDefaultsMongoResponse();
}
}  // namespace protobuf_brpc_2fpolicy_2fmongo_2eproto
namespace brpc {
namespace policy {
...
class MongoHeader : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.policy.MongoHeader) */ {
 public:
  ...
  inline MongoHeader* New() const PROTOBUF_FINAL { return New(NULL); }

  MongoHeader* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_brpc_2fpolicy_2fmongo_2eproto::InitDefaultsMongoHeaderImpl();
};
// -------------------------------------------------------------------
...
class MongoRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.policy.MongoRequest) */ {
 public:
  ...
  inline MongoRequest* New() const PROTOBUF_FINAL { return New(NULL); }

  MongoRequest* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_brpc_2fpolicy_2fmongo_2eproto::TableStruct;
  friend void ::protobuf_brpc_2fpolicy_2fmongo_2eproto::InitDefaultsMongoRequestImpl();
};
// -------------------------------------------------------------------
...
class MongoResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.policy.MongoResponse) */ {
 public:
  ...
  inline MongoResponse* New() const PROTOBUF_FINAL { return New(NULL); }

  MongoResponse* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_brpc_2fpolicy_2fmongo_2eproto::TableStruct;
  friend void ::protobuf_brpc_2fpolicy_2fmongo_2eproto::InitDefaultsMongoResponseImpl();
};
// ===================================================================
