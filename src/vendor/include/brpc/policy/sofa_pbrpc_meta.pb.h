...
void AddDescriptors();
void InitDefaultsSofaRpcMetaImpl();
void InitDefaultsSofaRpcMeta();
inline void InitDefaults() {
  InitDefaultsSofaRpcMeta();
}
}  // namespace protobuf_brpc_2fpolicy_2fsofa_5fpbrpc_5fmeta_2eproto
namespace brpc {
namespace policy {
...
class SofaRpcMeta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.policy.SofaRpcMeta) */ {
 public:
  ...
  inline SofaRpcMeta* New() const PROTOBUF_FINAL { return New(NULL); }

  SofaRpcMeta* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_brpc_2fpolicy_2fsofa_5fpbrpc_5fmeta_2eproto::InitDefaultsSofaRpcMetaImpl();
};
// ===================================================================
