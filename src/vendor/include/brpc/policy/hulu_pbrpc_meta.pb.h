...
void AddDescriptors();
void InitDefaultsHuluRpcRequestMetaImpl();
void InitDefaultsHuluRpcRequestMeta();
void InitDefaultsHuluRpcResponseMetaImpl();
void InitDefaultsHuluRpcResponseMeta();
inline void InitDefaults() {
  InitDefaultsHuluRpcRequestMeta();
  InitDefaultsHuluRpcResponseMeta();
}
}  // namespace protobuf_brpc_2fpolicy_2fhulu_5fpbrpc_5fmeta_2eproto
namespace brpc {
namespace policy {
...
class HuluRpcRequestMeta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.policy.HuluRpcRequestMeta) */ {
 public:
  ...
  inline HuluRpcRequestMeta* New() const PROTOBUF_FINAL { return New(NULL); }

  HuluRpcRequestMeta* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_brpc_2fpolicy_2fhulu_5fpbrpc_5fmeta_2eproto::InitDefaultsHuluRpcRequestMetaImpl();
};
// -------------------------------------------------------------------
...
class HuluRpcResponseMeta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.policy.HuluRpcResponseMeta) */ {
 public:
  ...
  inline HuluRpcResponseMeta* New() const PROTOBUF_FINAL { return New(NULL); }

  HuluRpcResponseMeta* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  ::google::protobuf::int64 user_defined_source_addr_;
  friend struct ::protobuf_brpc_2fpolicy_2fhulu_5fpbrpc_5fmeta_2eproto::TableStruct;
  friend void ::protobuf_brpc_2fpolicy_2fhulu_5fpbrpc_5fmeta_2eproto::InitDefaultsHuluRpcResponseMetaImpl();
};
// ===================================================================
