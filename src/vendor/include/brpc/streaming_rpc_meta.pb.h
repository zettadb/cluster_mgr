...
void AddDescriptors();
void InitDefaultsStreamSettingsImpl();
void InitDefaultsStreamSettings();
void InitDefaultsStreamFrameMetaImpl();
void InitDefaultsStreamFrameMeta();
void InitDefaultsFeedbackImpl();
void InitDefaultsFeedback();
inline void InitDefaults() {
  InitDefaultsStreamSettings();
  InitDefaultsStreamFrameMeta();
...
class StreamSettings : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.StreamSettings) */ {
 public:
  ...
  inline StreamSettings* New() const PROTOBUF_FINAL { return New(NULL); }

  StreamSettings* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_brpc_2fstreaming_5frpc_5fmeta_2eproto::InitDefaultsStreamSettingsImpl();
};
// -------------------------------------------------------------------
...
class StreamFrameMeta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.StreamFrameMeta) */ {
 public:
  ...
  inline StreamFrameMeta* New() const PROTOBUF_FINAL { return New(NULL); }

  StreamFrameMeta* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_brpc_2fstreaming_5frpc_5fmeta_2eproto::TableStruct;
  friend void ::protobuf_brpc_2fstreaming_5frpc_5fmeta_2eproto::InitDefaultsStreamFrameMetaImpl();
};
// -------------------------------------------------------------------
...
class Feedback : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.Feedback) */ {
 ...
 private:
  ...
  friend struct ::protobuf_brpc_2fstreaming_5frpc_5fmeta_2eproto::TableStruct;
  friend void ::protobuf_brpc_2fstreaming_5frpc_5fmeta_2eproto::InitDefaultsFeedbackImpl();
};
// ===================================================================
