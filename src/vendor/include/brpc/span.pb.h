...
void AddDescriptors();
void InitDefaultsRpczSpanImpl();
void InitDefaultsRpczSpan();
void InitDefaultsBriefSpanImpl();
void InitDefaultsBriefSpan();
void InitDefaultsSpanAnnotationImpl();
void InitDefaultsSpanAnnotation();
void InitDefaultsTracingSpanImpl();
void InitDefaultsTracingSpan();
inline void InitDefaults() {
  InitDefaultsRpczSpan();
  InitDefaultsBriefSpan();
  InitDefaultsSpanAnnotation();
  InitDefaultsTracingSpan();
}
}  // namespace protobuf_brpc_2fspan_2eproto
namespace brpc {
class BriefSpan;
...
class RpczSpan : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.RpczSpan) */ {
 public:
  ...
  inline RpczSpan* New() const PROTOBUF_FINAL { return New(NULL); }

  RpczSpan* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_brpc_2fspan_2eproto::InitDefaultsRpczSpanImpl();
};
// -------------------------------------------------------------------
...
class BriefSpan : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.BriefSpan) */ {
 public:
  ...
  inline BriefSpan* New() const PROTOBUF_FINAL { return New(NULL); }

  BriefSpan* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_brpc_2fspan_2eproto::TableStruct;
  friend void ::protobuf_brpc_2fspan_2eproto::InitDefaultsBriefSpanImpl();
};
// -------------------------------------------------------------------
...
class SpanAnnotation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.SpanAnnotation) */ {
 public:
  ...
  inline SpanAnnotation* New() const PROTOBUF_FINAL { return New(NULL); }

  SpanAnnotation* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_brpc_2fspan_2eproto::TableStruct;
  friend void ::protobuf_brpc_2fspan_2eproto::InitDefaultsSpanAnnotationImpl();
};
// -------------------------------------------------------------------
...
class TracingSpan : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.TracingSpan) */ {
 public:
  ...
  inline TracingSpan* New() const PROTOBUF_FINAL { return New(NULL); }

  TracingSpan* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  ::google::protobuf::int32 response_size_;
  friend struct ::protobuf_brpc_2fspan_2eproto::TableStruct;
  friend void ::protobuf_brpc_2fspan_2eproto::InitDefaultsTracingSpanImpl();
};
// ===================================================================
