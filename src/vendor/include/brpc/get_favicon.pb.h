...
void AddDescriptors();
void InitDefaultsGetFaviconRequestImpl();
void InitDefaultsGetFaviconRequest();
void InitDefaultsGetFaviconResponseImpl();
void InitDefaultsGetFaviconResponse();
inline void InitDefaults() {
  InitDefaultsGetFaviconRequest();
  InitDefaultsGetFaviconResponse();
}
}  // namespace protobuf_brpc_2fget_5ffavicon_2eproto
namespace brpc {
...
class GetFaviconRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.GetFaviconRequest) */ {
 public:
  ...
  inline GetFaviconRequest* New() const PROTOBUF_FINAL { return New(NULL); }

  GetFaviconRequest* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_brpc_2fget_5ffavicon_2eproto::InitDefaultsGetFaviconRequestImpl();
};
// -------------------------------------------------------------------
...
class GetFaviconResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.GetFaviconResponse) */ {
 public:
  ...
  inline GetFaviconResponse* New() const PROTOBUF_FINAL { return New(NULL); }

  GetFaviconResponse* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_brpc_2fget_5ffavicon_2eproto::TableStruct;
  friend void ::protobuf_brpc_2fget_5ffavicon_2eproto::InitDefaultsGetFaviconResponseImpl();
};
// ===================================================================
