...
void AddDescriptors();
void InitDefaultsRpcDumpMetaImpl();
void InitDefaultsRpcDumpMeta();
inline void InitDefaults() {
  InitDefaultsRpcDumpMeta();
}
}  // namespace protobuf_brpc_2frpc_5fdump_2eproto
namespace brpc {
class RpcDumpMeta;
...
class RpcDumpMeta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.RpcDumpMeta) */ {
 public:
  ...
  inline RpcDumpMeta* New() const PROTOBUF_FINAL { return New(NULL); }

  RpcDumpMeta* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_brpc_2frpc_5fdump_2eproto::InitDefaultsRpcDumpMetaImpl();
};
// ===================================================================
