...
void AddDescriptors();
void InitDefaultsNsheadMetaImpl();
void InitDefaultsNsheadMeta();
inline void InitDefaults() {
  InitDefaultsNsheadMeta();
}
}  // namespace protobuf_brpc_2fnshead_5fmeta_2eproto
namespace brpc {
class NsheadMeta;
...
class NsheadMeta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.NsheadMeta) */ {
 public:
  ...
  inline NsheadMeta* New() const PROTOBUF_FINAL { return New(NULL); }

  NsheadMeta* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_brpc_2fnshead_5fmeta_2eproto::InitDefaultsNsheadMetaImpl();
};
// ===================================================================
