...
void AddDescriptors();
void InitDefaultsTrackMeRequestImpl();
void InitDefaultsTrackMeRequest();
void InitDefaultsTrackMeResponseImpl();
void InitDefaultsTrackMeResponse();
inline void InitDefaults() {
  InitDefaultsTrackMeRequest();
  InitDefaultsTrackMeResponse();
}
}  // namespace protobuf_brpc_2ftrackme_2eproto
namespace brpc {
...
class TrackMeRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.TrackMeRequest) */ {
 public:
  ...
  inline TrackMeRequest* New() const PROTOBUF_FINAL { return New(NULL); }

  TrackMeRequest* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_brpc_2ftrackme_2eproto::InitDefaultsTrackMeRequestImpl();
};
// -------------------------------------------------------------------
...
class TrackMeResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.TrackMeResponse) */ {
 public:
  ...
  inline TrackMeResponse* New() const PROTOBUF_FINAL { return New(NULL); }

  TrackMeResponse* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_brpc_2ftrackme_2eproto::TableStruct;
  friend void ::protobuf_brpc_2ftrackme_2eproto::InitDefaultsTrackMeResponseImpl();
};
// ===================================================================
