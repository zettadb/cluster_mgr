...
def Query_Clusterdetail(job_id,cluster_name):
    ...
    #print(shard_port,com_ip,com_port)
...
if __name__ == "__main__":  
    ...
    current_latetime = (datetime.datetime.now()+datetime.timedelta(minutes = 25)).strftime("%Y-%m-%d %H:%M:%S")
    job_id= "1646995251"
    print(current_latetime)
    Create_Cluster(job_id)
    time.sleep(350)
    cluster_name = Query_Cluster(job_id)
    #cluster_name = "cluster_1651030216_000001"
    Query_Clusterdetail(job_id,cluster_name)
    ...
    time.sleep(10)
    #cluster_name = "cluster_1650853644_000001"
